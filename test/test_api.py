# Đăng nhập hệ thống OrangeHRM qua trình duyệt bằng Selenium
#
# Lấy cookie đăng nhập từ Selenium và gắn vào requests.Session()
#
# Gọi API lấy danh sách location và kiểm tra kết quả có đúng không
